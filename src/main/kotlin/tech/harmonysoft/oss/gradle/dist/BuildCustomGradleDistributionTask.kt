...
abstract class BuildCustomGradleDistributionTask : DefaultTask() {
    ...
    @TaskAction
    fun build() {
        val baseDistribution = getBaseGradleDistribution(project, config.get())
    ...
    private fun getBaseGradleDistribution(project: Project, extension: CustomGradleDistConfig): File {
        return try {
    ...
    private fun doGetBaseGradleDistribution(project: Project, extension: CustomGradleDistConfig): File {
